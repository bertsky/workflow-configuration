...
def cli(pagefile, inplace, backup):
    """partition PAGE-XML ReadingOrder from single OrderedGroup to top UnorderedGroup divided into OrderedGroups starting at every @heading-type text regions."""
    ...
    for rid in orderedgrouprefs:
        if textregiontypes[rid] == 'heading':
